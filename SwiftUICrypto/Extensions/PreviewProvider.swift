...
class DevloperPreview {
    ...
    let stat1 = StatisticModel(title: "market cap", value: "$12.5Bn", precentageChange: 24.5)
    let stat2 = StatisticModel(title: "Toatal cap", value: "$1.25Tr" )
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$50.5k", precentageChange: -24.5 )
